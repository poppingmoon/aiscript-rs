...
pub trait Visitor {
    fn visit_node(&self, node: cst::Node) -> Result<cst::Node, AiScriptError> {
        match node {
            cst::Node::Namespace(namespace) => self
                .visit_namespace(*namespace)
                .map(Into::into)
                .map(cst::Node::Namespace),
            cst::Node::Meta(meta) => self.visit_meta(*meta).map(Into::into).map(cst::Node::Meta),
    ...
    fn visit_statement(&self, statement: cst::Statement) -> Result<cst::Statement, AiScriptError> {
        ...
        Ok(match statement {
            cst::Statement::Definition(definition) => cst::Statement::Definition(
                cst::Definition {
            ...
            cst::Statement::Return(return_) => cst::Statement::Return(
                cst::Return {
            ...
            cst::Statement::Each(each) => cst::Statement::Each(
                cst::Each {
            ...
            cst::Statement::For(for_) => cst::Statement::For(
                cst::For {
                    from: for_
                        .from
            ...
            cst::Statement::Loop(loop_) => cst::Statement::Loop(
                cst::Loop {
                    statements: loop_
                        .statements
                        .into_iter()
            ...
            cst::Statement::Assign(assign) => cst::Statement::Assign(
                cst::Assign {
            ...
            cst::Statement::AddAssign(add_assign) => cst::Statement::AddAssign(
                cst::AddAssign {
            ...
            cst::Statement::SubAssign(sub_assign) => cst::Statement::SubAssign(
                cst::SubAssign {
    ...
    fn visit_expression(
        ...
        Ok(match expression {
            cst::Expression::Not(not) => cst::Expression::Not(
                cst::Not {
            ...
            cst::Expression::And(and) => cst::Expression::And(
                cst::And {
            ...
            cst::Expression::Or(or) => cst::Expression::Or(
                cst::Or {
            ...
            cst::Expression::If(if_) => cst::Expression::If(
                cst::If {
            ...
            cst::Expression::Match(match_) => cst::Expression::Match(
                cst::Match {
            ...
            cst::Expression::Exists(exists) => cst::Expression::Exists(
                cst::Exists {
                    identifier: *self
                        .visit_expression(cst::Expression::Identifier(exists.identifier.into()))
                        .map(|expression| {
            ...
            cst::Expression::Tmpl(tmpl) => cst::Expression::Tmpl(
                cst::Tmpl {
                    tmpl: tmpl
                        .tmpl
                        .into_iter()
            ...
            cst::Expression::Str(str) => cst::Expression::Str(
                cst::Str {
                    chain: str
                        .chain
                        .map(|chain| {
            ...
            cst::Expression::Num(num) => cst::Expression::Num(
                cst::Num {
                    chain: num
                        .chain
                        .map(|chain| {
            ...
            cst::Expression::Bool(bool) => cst::Expression::Bool(
                cst::Bool {
                    chain: bool
                        .chain
                        .map(|chain| {
            ...
            cst::Expression::Null(null) => cst::Expression::Null(
                cst::Null {
                    chain: null
                        .chain
                        .map(|chain| {
            ...
            cst::Expression::Obj(obj) => cst::Expression::Obj(
                cst::Obj {
                    value: obj
                        .value
                        .into_iter()
            ...
            cst::Expression::Arr(arr) => cst::Expression::Arr(
                cst::Arr {
                    value: arr
                        .value
                        .into_iter()
            ...
            cst::Expression::Identifier(identifier) => cst::Expression::Identifier(
                cst::Identifier {
                    chain: identifier
                        .chain
                        .map(|chain| {
            ...
            cst::Expression::Call(call) => cst::Expression::Call(
                cst::Call {
            ...
            cst::Expression::Index(index) => cst::Expression::Index(
                cst::Index {
            ...
            cst::Expression::Prop(prop) => cst::Expression::Prop(
                cst::Prop {
